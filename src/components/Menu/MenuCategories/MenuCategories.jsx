...
const MenuCategories = () => {
  return (
    <div className={styles.categoryList}>
        ...
        <Link href="/blog?cat=food" className={`${styles.categoryItem} ${styles.style}`}>Style</Link>
        <Link href="/blog?cat=food" className={`${styles.categoryItem} ${styles.coding}`}>Coding</Link>
    </div>
  )
}
